        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-lg sm:text-xl text-primary-foreground/90 text-pretty leading-relaxed">
              Discover championship-quality coffee from Brisbane. Each drip bag is carefully crafted for the perfect
              brew, every time.
            </p>
          </div>
        </div>
                ...
                <CardFooter className="p-6 pt-0">
                  <Button className="w-full group/btn" asChild>
                    <a href="https://www.instagram.com/dribagcoffee/" target="_blank" rel="noopener noreferrer">
                      <Instagram className="mr-2 h-4 w-4 group-hover/btn:scale-110 transition-transform" />
